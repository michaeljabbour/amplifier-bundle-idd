---
name: idd-composition-rules
description: >
  Six composition rules, merge semantics, confidence scoring, scope boundaries,
  agent matching, behavior stacking. Use when composing IDD primitives into
  executable plans or validating composition correctness.
version: 1.0.0
metadata:
  category: idd
---
