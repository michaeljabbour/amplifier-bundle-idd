---
name: idd-five-primitives
description: >
  Definitive reference for the five IDD primitives (Agent/WHO, Context/WHAT,
  Behavior/HOW, Intent/WHY, Trigger/WHEN). Fields, boundary rules, orthogonality
  tests, conflation patterns. Use when composing, reviewing, or checking
  orthogonality.
version: 1.0.0
metadata:
  category: idd
